...
import { eliminarIngrediente, getIngredientes, guardarIngredientes } from "../../service";
...
function IngredientePage() {
    ...
    const cargarAcciones = () => {
        eliminarIngrediente().then(data => {
            async function guardar() {

                const ingrediente = {data.map(ingrediente.id)

                }
                console.log("Eliminado ingrediente", ingrediente)
                await eliminarIngrediente(ingrediente);
            }
        }
